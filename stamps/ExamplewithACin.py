...
if __name__ == "__main__":
    ...
    unknowns = [f"V_{i+1}" for i in range(num_nodes)]  # Node voltages
    ...
    G, RHS = CircuitStamps.inductor_stamp(G, RHS, 3, 4, 1, s, num_nodes)  # 1 H inductor
    unknowns.append("I_L1")  # Current through inductor
    G, RHS = CircuitStamps.voltage_source_stamp(G, RHS, 1, 0, 2, num_nodes + 1)  # 2V AC voltage source
    unknowns.append("I_VS1")  # Current through voltage source
