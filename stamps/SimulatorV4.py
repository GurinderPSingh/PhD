...
if __name__ == "__main__":
    ...
    if analysis_choice == "1":
        ...
        try:
            ...
            tmax = 1e1
            dt = 1e-2
        # Updated transient analysis: now stamp voltage sources as well.
