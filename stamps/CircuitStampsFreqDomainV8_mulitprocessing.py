...
if __name__ == "__main__":
    ...
    # Adding components
    G = CircuitStamps.conductance_stamp(G, 1, 2, 5)
    C = CircuitStamps.capacitance_stamp(C, 2, 3, 5e-2)
    G, C, RHS = CircuitStamps.inductor_stamp(G, C, RHS, 3, 0, 0.001, num_nodes)
    unknowns.append("I_L1")
    G, C, RHS = CircuitStamps.voltage_source_stamp(G, C, RHS, 1, 0, 0.5, num_nodes + 1)
