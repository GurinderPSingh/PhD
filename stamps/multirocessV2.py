...
class CircuitStamps:
    ...
    here we are testing the padding issue with the voltage source.
    """
    ...
    def pad_matrices(g_matrix, c_matrix, rhs, required_size=None):
        ...
        - c_matrix: Capacitance matrix.
        - rhs: Right-hand side vector.
        - required_size: The minimum size the matrices and RHS vector should have.
        """
